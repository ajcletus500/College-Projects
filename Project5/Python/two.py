...
two_thread_workloads = [['applu', 'bzip2_source'],['crafty', 'apsi']]

#GLOBALS
bench_dir = "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/benchmarks/"
scr_dir = "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Project/two_core/Shells/" #--Please provide the exact path
exe = "smtsim"
exe_path = os.path.join("/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/smtsim/build.linux-amd64", exe)
sims_group = "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Project/two_core/Results/"  #-Please provide the exact path
thread_length = 1e7
ff_dist = 1e7	
host = ''
p=0
...
""" % (bench_dir, exe_path,  sims_group+simout_name, input1, "%e" %ff_dist, input2, "%e" %ff_dist, input1, input2,  "%e" %thread_length,conf['l2s'],conf['l2a'],conf['ics'],conf['ica'],conf['dcs'],conf['dca'], conf['lsq'], conf['iqs'], conf['fqs'],conf['fb'],conf['fb'],conf['mci'],conf['mci'],conf['mii'],conf['mfi'],conf['mli'],conf['ipr'],conf['fpr'],conf['rob'],get_ceil_power_of_two(conf['rob']*8), sims_group, simout_name)
    return script
