...
scr_dir = "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/smtsim-scripts/one_core/" #--Please provide the exact path 
#scr_dir= "one_core"
#scr_dir = os.getcwd()
#scr_dir = scr_dir.join("\")
#print(scr_dir)
#scr_dir=scr_dir+"/one_core/"
#scr_dir=scr_dir.replace("/","\\")
#scr_dir=scr_dir.replace("\\mnt\\c","C:")
print(scr_dir)
exe = "smtsim"
exe_path = os.path.join("/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/smtsim/build.linux-amd64", exe) 
sims_group = "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/results/HW1/one_core/"  #-Please provide the exact path
thread_length = 1e6
ff_dist = 1e6
host = ''
...
""" % (bench_dir, exe_path,  sims_group+simout_name, input1, "%e" %ff_dist, input1, "%e" %thread_length,conf['ics'],conf['ica'],conf['dcs'],conf['dca'], conf['lsq'], conf['iqs'], conf['fqs'],conf['fb'],conf['fb'],conf['mci'],conf['mci'],conf['mii'],conf['mfi'],conf['mli'],conf['ipr'],conf['fpr'],conf['rob'],get_ceil_power_of_two(conf['rob']*8), sims_group, simout_name, configs_to_test)
    return script
