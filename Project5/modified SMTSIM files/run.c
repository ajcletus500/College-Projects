...
long long int commit_instr = 0;
long long int curr_commit_instr = 0;
long long int prev_commit_instr = 0;
long long int prev_cyc = 0;
long long int cyc_interval = 0;
double current_ipc = 0;
int a=0;
int ab=1;
long long int prev_commit_instr1 = 0;
long long int prev_cyc1 = 0;
long long int commit_instr1 = 0;
long long int pp =0;
/*
 ...
 */
    ...
    if (warmup) {printf("working8");
            allinstructions = CtxCount * warmuptime;
    } else {
	printf("working9");
        allinstructions = (GlobalParams.allinstructions >= 0) ?
            GlobalParams.allinstructions : 
            ( CtxCount * GlobalParams.thread_length);
    }
	...
	//printf("working10");
      /*  going through the pipeline back to front ensures that instructions
        ...
        cyc++;
		//if (cyc % 10000 == 0)
		//printf("cycle= %lli curr_commit_instr =%s \n ", (cyc), fmt_i64(curr_commit_instr));
