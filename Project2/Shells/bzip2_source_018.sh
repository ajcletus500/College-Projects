#!/bin/bash
					...
					/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/smtsim/build.linux-amd64/smtsim -conffile "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/benchmarks/workloads-list_ffs0.conf" \
												  ...
												  -confexpr "AppStatsLog/base_name = \"/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment3/Results/bzip2_source_018\";" \
												  ...
												  -confexpr "Core/Queue/max_float_issue = 2;" \
												  -confexpr "Core/Queue/max_ldst_issue = 2;" \
												  -confexpr "Core/Rename/int_rename_regs = 96;" \
												  -confexpr "Core/Rename/float_rename_regs = 96;" \
												  -confexpr "Thread/reorder_buffer_size = 48;" \
												  -confexpr "Core/Decode/total_limit = 2;" \
												  -confexpr "Thread/active_list_size = 512;" \
												  -confexpr "ResourcePooling/enable = f;" \
												  -confdump - > "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment3/Results/bzip2_source_018"
