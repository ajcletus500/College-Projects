#!/bin/bash
					...
					/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/smtsim/build.linux-amd64/smtsim -conffile "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/benchmarks/workloads-list_ffs0.conf" \
												  ...
												  -confexpr "AppStatsLog/base_name = \"/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/results/HW2/IPC_512/bzip2_source_105\";" \
												  ...
												  -confexpr "Core/Fetch/single_limit = 2;" \
												  -confexpr "Core/Fetch/total_limit = 2;" \
												  -confexpr "Core/Commit/single_limit = 2;" \
												  -confexpr "Core/Commit/total_limit = 2;" \
												  ...
												  -confexpr "Core/Decode/total_limit = 2;" \
												  -confexpr "Thread/active_list_size = 1024;" \
												  -confexpr "ResourcePooling/enable = f;" \
												  -confdump - > "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/results/HW2/IPC_512/bzip2_source_105"
