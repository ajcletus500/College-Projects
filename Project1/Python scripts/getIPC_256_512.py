...
dir_path = "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/results/HW2/IPC_256/"
...
file_list.sort()
#print(file_list)
with open('L2_256.csv', 'w') as out_file:
		...
		#print in_file.readline(10)
        	for line in in_file:		
				if re.match("(.*)total IPC(.*)", line):
					print line,
					out_file.write(filename.split('IPC_256/')[1]+'=')
