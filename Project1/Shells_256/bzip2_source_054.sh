#!/bin/bash
					...
					/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/smtsim/build.linux-amd64/smtsim -conffile "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/benchmarks/workloads-list_ffs0.conf" \
												  ...
												  -confexpr "AppStatsLog/base_name = \"/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/results/HW2/IPC_256/bzip2_source_054\";" \
												  ...
												  -confexpr "Core/ICache/size_kb = 8;" \
												  -confexpr "Core/ICache/assoc = 32;" \
												  ...
												  -confexpr "Core/DCache/size_kb = 8;" \
												  -confexpr "Core/DCache/assoc = 32;" \
												  ...
												  -confexpr "Thread/reorder_buffer_size = 96;" \
												  -confexpr "Core/Decode/total_limit = 1;" \
												  -confexpr "Thread/active_list_size = 1024;" \
												  -confexpr "ResourcePooling/enable = f;" \
												  -confdump - > "/mnt/c/Users/hp/OneDrive/GMU_Notes/Sem4/611/Assignment1/SMTSIM/results/HW2/IPC_256/bzip2_source_054"
